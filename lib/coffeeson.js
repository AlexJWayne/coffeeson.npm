(function() {
  var coffee, compile, convertFile, convertFilePretty, fileToJSON, fileToPrettyJSON, fs, parse, parseFile, toJSON, toPrettyJSON,
  ...
  toPrettyJSON = function(src, replacer) {
  ...
  fileToPrettyJSON = function(name, cb) {
  ...
  convertFilePretty = function(name, cb) {
  ...
  module.exports = {
    ...
    fileToPrettyJSON: fileToPrettyJSON,
    convertFile: convertFile,
    convertFilePretty: convertFilePretty
  };
